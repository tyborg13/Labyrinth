...
boss-room repositioning. Elemental combat rooms seed 2-3 traps across eligible
passable floor tiles, including the playable edge band, and those traps blast
adjacent tiles when stepped on or attacked. First-sequence standard trap damage
is 6/7/8 player-scale damage at depths 1/2/3, first-boss traps hit for 5 to
avoid one-shotting full-health lightning wisps, and later sequences add 2
