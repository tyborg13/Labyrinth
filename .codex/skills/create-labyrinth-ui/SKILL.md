...
- Preserve every input path the current surface supports. When controller support is present, include focus traversal, activation, back/cancel, focus recovery, and input handoff where applicable; do not infer a handheld-resolution proof requirement from controller support alone.
