...
func _run() -> void:
	...
	output = ProjectSettings.globalize_path("user://protagonist_2d_board_front_only_v7" if front_only else "user://protagonist_2d_board_full_v7")
