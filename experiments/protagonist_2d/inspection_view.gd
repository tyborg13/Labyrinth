...
func _build_view() -> void:
	...
	_label("Original painted artwork on a live 2D rig", Vector2(32, 70), Vector2(1250, 28), Typography.ROLE_BODY_LARGE)
	board = Board.new()
	...
	_label("Original and live cutout", Vector2(1340, 42), Vector2(520, 36), Typography.ROLE_TITLE)
