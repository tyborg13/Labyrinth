...
const CombatOverhaulFoundationSuite = preload("res://tests/suites/combat_overhaul_foundation_suite.gd")
...
func _initialize() -> void:
	...
	CombatOverhaulFoundationSuite.run(Callable(self, "_assert"))
	ProgressionStore.set_run_storage_path("user://labyrinth_run_test.save")
