...
func _ready() -> void:
	var renderer_script: Script = load("res://scripts/vyraketh_cutout/renderer.gd") as Script
	...
	print("VYRAKETH CUTOUT EXPORT RUNTIME: " + ("PASS" if passed else "FAIL") + " (editor=" + str(OS.has_feature("editor")) + ")")
