...
func _ready() -> void:
	var renderer_script: Script = load("res://scripts/zekarion_cutout/renderer.gd") as Script
	...
	print("ZEKARION CUTOUT EXPORT RUNTIME: " + ("PASS" if passed else "FAIL") + " (editor=" + str(OS.has_feature("editor")) + ")")
