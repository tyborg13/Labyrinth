...
func _ready() -> void:
	var renderer_script: Script = load("res://scripts/crawler_cutout/renderer.gd") as Script
	...
	print("CRAWLER CUTOUT EXPORT RUNTIME: " + ("PASS" if passed else "FAIL") + " (editor=" + str(OS.has_feature("editor")) + ")")
