...
func _ready() -> void:
	var renderer_script: Script = load("res://scripts/stone_warden_cutout/renderer.gd") as Script
	...
	print("WARDEN CUTOUT EXPORT RUNTIME: " + ("PASS" if passed else "FAIL") + " (editor=" + str(OS.has_feature("editor")) + ")")
