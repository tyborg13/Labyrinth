...
func _ready() -> void:
	var renderer_script: Script = load("res://scripts/grave_surgeon_cutout/renderer.gd") as Script
	...
	print("GRAVE SURGEON CUTOUT EXPORT RUNTIME: " + ("PASS" if passed else "FAIL") + " (editor=" + str(OS.has_feature("editor")) + ")")
