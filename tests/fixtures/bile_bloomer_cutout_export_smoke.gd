...
func _ready() -> void:
	var renderer_script: Script = load("res://scripts/bile_bloomer_cutout/renderer.gd") as Script
	...
	print("BILE BLOOMER CUTOUT EXPORT RUNTIME: " + ("PASS" if passed else "FAIL") + " (editor=" + str(OS.has_feature("editor")) + ")")
