...
func _ready() -> void:
	var renderer_script: Script = load("res://scripts/cinder_droplet_cutout/renderer.gd") as Script
	...
	print("CINDER DROPLET CUTOUT EXPORT RUNTIME: " + ("PASS" if passed else "FAIL") + " (editor=" + str(OS.has_feature("editor")) + ")")
