...
- Before implementation, record observable acceptance criteria, required proof, risk tier, and inspection expectation with `python3 tools/parallel_task.py contract ...`, then pass `python3 tools/parallel_task.py preflight`. See `spec/development_workflow.md` for risk-tier proof breadth.
