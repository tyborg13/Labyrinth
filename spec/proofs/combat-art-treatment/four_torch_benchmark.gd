...
func _initialize() -> void:
	...
	var results: Dictionary = {
		"schema_version": 2,
		"workload_id": "combat_board_four_torch_active_umbra_v1",
...
func _stress_grid() -> Array:
	...
	for tile: Vector2i in [Vector2i(1, 1), Vector2i(7, 1), Vector2i(1, 7)]:
		(grid[tile.y] as Array)[tile.x] = "pillar"
	return grid
...
func _verify_static_render_cache_visual_equivalence(board: Control, viewport: SubViewport) -> Dictionary:
	...
	var presentation: Dictionary = {"board_backdrop_visible": true, "reduced_motion": true}
	board.set_process(false)
