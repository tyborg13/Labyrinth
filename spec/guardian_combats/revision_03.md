...
Proof manifests: `output/guardian-revision-03/ui-v08.json` (28 images) and `outcrop-v09.json` (6 images). Curated screenshots and logs are retained with `output/guardian-revision-03/review.md`. Character rigs and their existing reviewed animation exports are unchanged in this pass.
