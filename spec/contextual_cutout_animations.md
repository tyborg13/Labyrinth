...
- A death descriptor overrides other poses. Collapse reaches its authored endpoint at 62% of the existing dissolve timeline (0.64232 seconds of the 1.036-second enemy effect), then holds while the original shadow dissolve finishes. No extra wait is added.
