...
const INTRO_TEXT_FADE_DELAY_SECONDS: float = 0.44
const INTRO_TEXT_FADE_SECONDS: float = 0.16
const INTRO_CONTENT_DELAY_SECONDS: float = 0.50
const INTRO_CONTENT_FADE_SECONDS: float = 0.14
