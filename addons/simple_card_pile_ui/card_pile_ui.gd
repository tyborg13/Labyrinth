...
@export var draw_pile_position: Vector2
@export var hand_pile_position: Vector2
...
func update_positions():
	draw_pile_position = Vector2(get_parent().size.x * 0.05, get_parent().size.y - 225)
	hand_pile_position = Vector2(get_parent().size.x * 0.5, get_parent().size.y - 225)
	discard_pile_position = Vector2(get_parent().size.x * 0.95, get_parent().size.y - 225)
